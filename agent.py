...
class Agent():
	def __init__(self, nstocks, nfeatures,)
...
class Policy(object):
	...
	def __init__(self, m, n, sess, optimizer, trading_cost=trading_cost, interest_rate=interest_rate, n_filter_1=n_filter_1, n_filter_2=n_filter_2):
		# parameters
